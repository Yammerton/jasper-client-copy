...
class TestMic(unittest.TestCase):
    ...
    def setUp(self):
        self.rex_clip = "../static/audio/rex.wav"
    ...
    def testTranscriberex(self):
        """Does rex recognize his name (i.e., passive listen)?"""
        transcription = self.m.transcribe(self.rex_clip, PERSONA_ONLY=True)
        self.assertTrue("rex" in transcription)

    def testTranscribe(self):
        """Does rex recognize 'time' (i.e., active listen)?"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Test suite for the rex client code.')
